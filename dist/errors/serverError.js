...
function (_Error) {
  ...
  function ServerError(err) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ServerError).call(this));
    _this.message = err && err.message ? 'Internal Server Error ' + err.message : 'Internal Server Error';
